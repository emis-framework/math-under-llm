...
# 模型超参数 (DeepSeek-R1-Distill-Qwen-14B 同 Qwen2.5-14B-Instruct)
D_HEAD = 128
N_Q_HEADS = 40
N_KV_HEADS = 8
...
# 自动查找分片
file_pattern = "*Qwen2.5-14B-Instruct-model*.safetensors"
...
# ---------------------------- 主流程：逐分片加载 ----------------------------
print(f"\n开始分析 Qwen2.5-14B-Instruct，共 {len(LAYERS_TO_ANALYZE)} 层")
analyzed_layers = set()
